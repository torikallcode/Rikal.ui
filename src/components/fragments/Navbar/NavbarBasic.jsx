    ...
    <header className="bg-gray-100 border-b border-gray-200">
      <nav className="relative flex items-center justify-between h-16 lg:h-20">
        <div className="hidden lg:flex lg:items-center lg:space-x-10">
          <a href="#" className="text-base font-medium text-black">Features</a>

          <a href="#" className="text-base font-medium text-black">Solutions</a>

          <a href="#" className="text-base font-medium text-black">Resources</a>

          <a href="#" className="text-base font-medium text-black">Pricing</a>
        </div>
